...
if(isset($subid) && isset($testid))/* we check here that if the $subid and testid are set */

{  
$_SESSION[sid]=$subid;/* if they are set the we create a seesion varriable name sid and tid  */
$_SESSION[tid]=$testid;
header("location:quiz.php"); //*reallocation command 
}
...
session_destroy();
echo "Please <a href=index2.php> Start Again</a>";
...
echo "<tr><td class=style1><input type=radio name=ans value=1>$row[3]";
